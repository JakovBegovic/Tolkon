...
lv_obj_t * ui_Parking_assistant;
lv_obj_t * ui_Overlay2;
void ui_event_main_display_button(lv_event_t * e);
lv_obj_t * ui_main_display_button;
lv_obj_t * ui_Label2;
lv_obj_t * ui_auto;
lv_obj_t * ui_senzorFlag1;
lv_obj_t * ui_senzorFlag2;
lv_obj_t * ui_senzorFlag3;
lv_obj_t * ui_senzorFlag4;
void ui_event_Camera_View(lv_event_t * e);
lv_obj_t * ui_Camera_View;
lv_obj_t * ui_Camera_View1;


// SCREEN: ui_Warning_Scr
void ui_Warning_Scr_screen_init(void);
lv_obj_t * ui_Warning_Scr;
lv_obj_t * ui_Overlay1;
lv_obj_t * ui_Time1;
lv_obj_t * ui_Temp1;
lv_obj_t * ui_Image2;
lv_obj_t * ui_Image4;
...
const lv_img_dsc_t * ui_imgset_auto_[1] = {&ui_img_auto_2_png};
const lv_img_dsc_t * ui_imgset_linije_[1] = {&ui_img_linije_2_png};
...
void ui_event_Button1(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_RELEASED) {
        _ui_screen_change(&ui_Parking_assistant, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_Parking_assistant_screen_init);
    }
}
void ui_event_Button_text(lv_event_t * e)
{
...
void ui_event_Camera_View(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_RELEASED) {
        _ui_screen_change(&ui_Warning_Scr, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_Warning_Scr_screen_init);
    }
}
...
void ui_init(void)
{
    ...
    ui_Parking_assistant_screen_init();
    ui_Warning_Scr_screen_init();
